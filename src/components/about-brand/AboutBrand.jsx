            ...
            <section className="about-brand">
                ...
                <div className="about-brand-container">
                    ...
                    <div className="about-brand-content">
                        <p>Founded in 1905, GhanaSingh be true jewels is a prestigious jewellery brand with a legacy of 120 years in fine craftsmanship. Our heritage reflects a deep commitment to authenticity, quality, and timeless design.</p>
                        ...
                        <p>With a blend of tradition and innovation, GhanaSingh Be True Jewels continues to be a trusted name for generations seeking beauty, value, and authenticity.</p>
                    </div>
                </div>
            </section>
        </>
